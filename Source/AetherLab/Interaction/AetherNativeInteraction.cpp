...
bool AetherNativeInteraction::IsSceneService(EAetherInteractionActionKind K)
{
    ...
    switch(K){case E::Rest:case E::Train:case E::Trade:case E::Repair:case E::BeginDaily:case E::DrawWater:case E::PourWater:
    case E::OpenGate:case E::CloseGate:case E::StartEncounter:case E::ChannelEncounter:case E::CollectLegacyLoot:
    case E::RecruitGuard:case E::RecruitHealer:return true;default:return false;}
}
