...
{
    AETHERLAB_API bool ConvertWorld(const UAetherFrontierSave& Source,const FString& SourceSha256,
    ...
    AETHERLAB_API bool ConvertSnapshot(const UAetherFrontierSave& Source,const FString& SourceSha256,
