...
{
bool ValidateLoadout(const FAetherProfile& P,const FAetherRules& R)
{
...
bool Equip(FAetherProfile& P,FGuid Id,const FAetherRules& R)
{
...
bool BuildLoadout(const FAetherProfile& P,const FAetherRules& R,TArray<FAetherEquippedSlot>& Out)
{
...
bool OwnsEquipment(const FAetherProfile& P,FName Id,const FAetherRules& R)
{
