...
UCLASS()
class AETHERGAMEPLAY_API UAetherEquipmentEffect : public UGameplayEffect
{
    GENERATED_BODY()
public:
...
{
    AETHERGAMEPLAY_API bool Publish(UAbilitySystemComponent& ASC,FActiveGameplayEffectHandle& Source,
