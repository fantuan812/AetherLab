...
UCLASS()
class AETHERGAMEPLAY_API AAetherWorldObject : public AActor, public IAetherHitReceiver
{
    GENERATED_BODY()
public:
    AAetherWorldObject();
...
UCLASS()
class AETHERGAMEPLAY_API AAetherAdventureState : public AGameStateBase
{
    GENERATED_BODY()
public:
    virtual void BeginPlay() override;
...
UCLASS()
class AETHERGAMEPLAY_API UAetherAdventureSave : public USaveGame
{
    GENERATED_BODY()
public:
...
UCLASS()
class AETHERGAMEPLAY_API AAetherAdventureMode : public AGameModeBase
{
    GENERATED_BODY()
public:
...
UCLASS()
class AETHERGAMEPLAY_API AAetherModularAdventureMode : public AAetherAdventureMode
{
    GENERATED_BODY()
public:
...
UCLASS()
class AETHERGAMEPLAY_API AAetherAdventureHUD : public AHUD
{
    GENERATED_BODY()
public:
