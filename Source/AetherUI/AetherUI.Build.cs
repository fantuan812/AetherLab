...
public class AetherUI : ModuleRules
{
    public AetherUI(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new[] { "Core", "CoreUObject", "Engine", "UMG", "CommonUI", "CommonInput", "SlateCore", "Slate", "InputCore", "AetherLab", "AetherEquipment", "AetherCore" });
