...
private:
    ...
    UPROPERTY(Transient, meta=(BindWidgetOptional)) TObjectPtr<UHorizontalBox> StatusBar;
    FGuid SeenSelected;
    ...
    UPROPERTY(Transient, meta=(BindWidgetOptional)) TObjectPtr<UUniformGridPanel> ContainerGrid;
    UPROPERTY(Transient, meta=(BindWidgetOptional)) TObjectPtr<UTextBlock> ContainerTitle;
    ...
    UPROPERTY(Transient, meta=(BindWidgetOptional)) TObjectPtr<UTextBlock> Summary;
