...
& $taskEditor (Join-Path $taskRoot 'AetherLab.uproject') '/Game/AetherCore/Maps/L_Frontier?game=/Script/AetherLab.AetherFrontierMode?DevProfile=ReactionCheck' -game -nullrhi -nosound -unattended -nop4 -AetherReactionCheck "-AetherSavePrefix=$taskPrefix" "-AetherLegacyFixture=$LegacyFixture" "-abslog=$taskLog"
